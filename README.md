...
This project provides a Docker container for visualizing a robot URDF model and calculating inverse kinematics. It uses ROS Noetic and Python libraries to generate a 3D visualization and calculate joint angles for a given end-effector position.
<p align="center">
